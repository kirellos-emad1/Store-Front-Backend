...
var orderModel = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, myConn.query(sql, [order.status, order.user_id])];
                    case 2:
                        result = _a.sent();
                        myConn.release();
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("Can't create order :Error ".concat(error_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("No orders to view ".concat(err_1));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    orderModel.prototype.addProductToOrder = function (product) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    orderModel.prototype.completedOrders = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("There is no completed order".concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
